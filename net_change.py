...
class VTSNN_IF_change(nn.Module):
    def __init__(self, last_layer_threshold):
        super(VTSNN_IF_change, self).__init__()
...
class VTSNN_LIF_change(nn.Module):
    def __init__(self, last_layer_threshold):
        super(VTSNN_LIF_change, self).__init__()
...
model = VTSNN_IF_change(last_layer_threshold=0.077)
